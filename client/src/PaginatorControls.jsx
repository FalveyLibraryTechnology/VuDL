...
class PaginatorControls extends React.Component {
    ...
    getLabel(useMagic) {
        ...
        return label.length === 0 && useMagic
            ? this.props.paginator.getLabel(
                  this.props.paginator.state.currentPage
              )
            : label;
    }
        ...
        return (
            <div className="controls">
                <div className="group">
                    ...
                    <input
                        type="text"
                        value={this.props.paginator.getLabel(
                            this.props.paginator.state.currentPage,
                            false
                        )}
                        ref={(l) => {
                    ...
                    />
                    <button onClick={this.props.paginator.prevPage}>
                        Prev
                    </button>
                    <button
                        onClick={function () {
                ...
                <PaginatorControlGroup
                    callback={this.setLabelPrefix}
                    label="prefixes"
                >
                    {MagicLabeler.prefixes}
                </PaginatorControlGroup>
                <PaginatorControlGroup
                    callback={this.setLabelBody}
                    label="labels"
                >
                    {MagicLabeler.labels}
                </PaginatorControlGroup>
                <PaginatorControlGroup
                    callback={this.setLabelSuffix}
                    label="suffixes"
                >
                ...
                <button
                    onClick={this.props.paginator.autonumberFollowingPages}
                    title="Autonumber Following Pages"
                >
                    <i className="fa fa-sort-numeric-down"></i>
                </button>
                <button
                    className="danger"
                    onClick={this.props.paginator.deletePage}

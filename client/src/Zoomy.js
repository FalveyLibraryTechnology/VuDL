var Zoomy = {
    ...
    init: function (canvas) {
        ...
        window.addEventListener("mousemove", Zoomy.mouseHandle, false);
    ...
    mouseHandle: function (e) {
        ...
        var mx = e.type.match("touch") ? e.targetTouches[0].pageX : e.pageX;
        mx -= bounds.left;
        var my = e.type.match("touch") ? e.targetTouches[0].pageY : e.pageY;
    ...
    center: function () {
        ...
        this.image.zoom = this.image.minZoom = Math.min(
            (this.width - 10) / this.image.content.width,
            1,
